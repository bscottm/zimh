...
int main(void)
{
    const struct CMUnitTest tests[] = {
        cmocka_unit_test(test_set_thread_name_null),
        cmocka_unit_test(test_set_thread_name_empty),
        cmocka_unit_test(test_set_thread_name_normal),
        cmocka_unit_test(test_set_thread_name_long),
        cmocka_unit_test(test_set_thread_name_special_chars),
        cmocka_unit_test(test_set_thread_name_unicode),
        cmocka_unit_test(test_set_thread_name_repeated),
        cmocka_unit_test(test_set_thread_name_whitespace),
    };
